...
# TODO 1: 创建随机森林模型（设置 n_estimators=100, random_state=42）
rf = None  # 替换 None 为你的代码

# TODO 2: 用训练数据拟合模型
pass  # 替换 pass 为你的代码

# TODO 3: 用测试数据预测
y_pred_rf = None  # 替换 None 为你的代码

# TODO 4: 计算准确率
acc_rf = None  # 替换 None 为你的代码

# --- 对比结果 ---
print(f"KNN (k=5)   准确率: {acc_knn:.4f}")
print(f"决策树      准确率: {acc_dt:.4f}")
print(f"随机森林    准确率: {acc_rf}")
print()
...
for k in k_values:
    # TODO 5: 创建 KNN 模型，设置 n_neighbors=k
    knn_k = None  # 替换 None 为你的代码

    # TODO 6: 拟合模型并预测
    pass  # 替换 pass 为你的代码（拟合）
    y_pred_k = None  # 替换 None 为你的代码（预测）

    # TODO 7: 计算准确率并存入 accuracies 列表
    acc = None  # 替换 None 为你的代码
    accuracies.append(acc)

    print(f"k = {k}  准确率: {acc}")

# TODO 8: 找出最佳 k 值
# 提示：可以用 np.argmax(accuracies) 找到最大值的索引
best_idx = None  # 替换 None 为你的代码
...
# （可选）画出 k 值与准确率的折线图
# 如果你完成了上面的 TODO，可以取消下面代码的注释来生成图表：
#
